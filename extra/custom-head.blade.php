...
@font-face { font-family: love; src: url('{{themeAsset('Love.ttf')}}'); } 
@font-face { font-family: fragmentcore; src: url('{{themeAsset('Fragmentcore.otf')}}'); } 
@font-face { font-family: zschusch; src: url('{{themeAsset('Zschusch.ttf')}}'); } 
